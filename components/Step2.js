...
import { VIDEO_LOADING_MESSAGES, API_KEY } from '../constants.js';
import Loader from './Loader.js';

const Step2 = ({ generatedImage, imageMimeType, onStartOver, numFamilyMembers }) => {
    ...
    const handleGenerateVideo = async () => {
        ...
        try {
            ...
            if (typeof errorMessage === 'string' && (errorMessage.includes('RESOURCE_EXHAUSTED') || errorMessage.includes('quota'))) {
                ...
                errorMessage = 'The API key is invalid. Please check the API_KEY constant in the constants.js file.';
            }
